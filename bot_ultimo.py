...
class SuperYouTubeDownloader:
    ...
    async def download_audio(self, url, user_id, format='mp3', quality='192'):
        """Download audio VELOCE con opzioni ottimizzate"""
        ...
        try:
            ...
            # Configurazione OTTIMIZZATA per download VELOCE
            ydl_opts = {
                'format': 'bestaudio[ext=m4a]/bestaudio/best',  # Preferisce M4A per velocità
                ...
                'concurrent_fragment_downloads': 4,  # Download paralleli
                'fragment_retries': 3,
                'retries': 3,
                'socket_timeout': 30,
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Comando start con tema BELLISSIMO"""
...
• 🌍 Totali bot: **{downloader.download_stats.get('total_downloads', 0)}**
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Comando help con tema BELLISSIMO"""
    help_text = """🎧✨ **SUPER YOUTUBE MUSIC BOT** ✨🎧
...
async def stats_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Mostra statistiche con tema BELLISSIMO"""
    ...
    stats_text = f"""📊✨ **LE TUE STATISTICHE** ✨📊
...
async def playlist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Comando download playlist con tema BELLISSIMO"""
    playlist_text = """🎶✨ **MODALITÀ PLAYLIST** ✨🎶
...
• 🔥 Elaborazione batch VELOCISSIMA
...
🎵 **Invia un URL playlist per iniziare!** 🚀"""
...
async def settings_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Comando impostazioni con tema BELLISSIMO"""
    settings_text = """⚙️✨ **IMPOSTAZIONI** ✨⚙️
...
async def handle_url(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Gestore URL con tema BELLISSIMO e pulsanti colorati"""
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Gestore callback con tema BELLISSIMO"""
